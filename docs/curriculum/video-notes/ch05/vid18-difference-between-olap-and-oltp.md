...
**Course lesson:** [Difference between OLAP and OLTP](https://maharatech.gov.eg/mod/hvp/view.php?id=17627)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17627
- My SQL script: `../scripts/ch05/vid18-difference-between-olap-and-oltp.sql`
