...
- [ ] 🚀 **Production Code Verified** · Documented implementation tracked in `src/07_warehousing_and_reporting/01_oltp_source_schema.sql`

---

## 1. Learning Objectives & Architectural Focus

By the end of this lesson, I should be able to explain the core idea behind **Difference between OLAP and OLTP**, write/reproduce a small working example, and describe when the feature is useful in a real SQL Server data platform.
...
* 🔗 **Official Course Module:** [MaharaTech Lesson 17627](https://maharatech.gov.eg/mod/hvp/view.php?id=17627)
* 💾 **Production Script:** [`src/07_warehousing_and_reporting/01_oltp_source_schema.sql`](../../../../src/07_warehousing_and_reporting/01_oltp_source_schema.sql)
