...
**Course lesson:** [Create custom reports using Microsoft RDLC Report Designer](https://maharatech.gov.eg/mod/hvp/view.php?id=17624)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17624
- My SQL script: `../scripts/ch05/vid15-create-custom-reports-using-microsoft-rdlc-report-designer.sql`
