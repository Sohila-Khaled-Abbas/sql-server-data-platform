...
**Course lesson:** [Using Stored Procedures & Map dataset to report parameter](https://maharatech.gov.eg/mod/hvp/view.php?id=17618)  
**Chapter:** Reporting and Data Warehousing
**Status:** ☐ Watched · ☐ Reproduced · ☐ Understood · ☐ Documented

## 1. What I should learn

By the end of this lesson, I should be able to explain the core idea behind **Using Stored Procedures & Map dataset to report parameter**, write/reproduce a small working example, and describe when the feature is useful in a real SQL Server data platform.
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17618
- My SQL script: `../scripts/ch05/vid09-using-stored-procedures-map-dataset-to-report-parameter.sql`
