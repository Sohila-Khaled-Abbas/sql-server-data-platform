...
**Course lesson:** [How to deploy reports & configure report server](https://maharatech.gov.eg/mod/hvp/view.php?id=17622)  
**Chapter:** Reporting and Data Warehousing
**Status:** ☐ Watched · ☐ Reproduced · ☐ Understood · ☐ Documented

## 1. What I should learn

By the end of this lesson, I should be able to explain the core idea behind **How to deploy reports & configure report server**, write/reproduce a small working example, and describe when the feature is useful in a real SQL Server data platform.
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17622
- My SQL script: `../scripts/ch05/vid13-how-to-deploy-reports-configure-report-server.sql`
