...
**Course lesson:** [Join many tables using query designer & Add indicators](https://maharatech.gov.eg/mod/hvp/view.php?id=17617)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17617
- My SQL script: `../scripts/ch05/vid08-join-many-tables-using-query-designer-add-indicators.sql`
