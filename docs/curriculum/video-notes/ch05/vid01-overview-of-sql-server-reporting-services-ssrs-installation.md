...
**Course lesson:** [Overview of SQL Server Reporting Services (SSRS) & installation](https://maharatech.gov.eg/mod/hvp/view.php?id=17610)  
**Chapter:** Reporting and Data Warehousing
**Status:** ☐ Watched · ☐ Reproduced · ☐ Understood · ☐ Documented

## 1. What I should learn

By the end of this lesson, I should be able to explain the core idea behind **Overview of SQL Server Reporting Services (SSRS) & installation**, write/reproduce a small working example, and describe when the feature is useful in a real SQL Server data platform.
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17610
- My SQL script: `../scripts/ch05/vid01-overview-of-sql-server-reporting-services-ssrs-installation.sql`
