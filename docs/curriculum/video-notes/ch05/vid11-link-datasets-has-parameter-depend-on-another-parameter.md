...
**Course lesson:** [Link datasets has parameter depend on another parameter](https://maharatech.gov.eg/mod/hvp/view.php?id=17620)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17620
- My SQL script: `../scripts/ch05/vid11-link-datasets-has-parameter-depend-on-another-parameter.sql`
