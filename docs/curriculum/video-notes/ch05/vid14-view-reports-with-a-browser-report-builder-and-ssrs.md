...
**Course lesson:** [View reports with a browser (Report Builder and SSRS)](https://maharatech.gov.eg/mod/hvp/view.php?id=17623)  
**Chapter:** Reporting and Data Warehousing
**Status:** ☐ Watched · ☐ Reproduced · ☐ Understood · ☐ Documented

## 1. What I should learn

By the end of this lesson, I should be able to explain the core idea behind **View reports with a browser (Report Builder and SSRS)**, write/reproduce a small working example, and describe when the feature is useful in a real SQL Server data platform.
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17623
- My SQL script: `../scripts/ch05/vid14-view-reports-with-a-browser-report-builder-and-ssrs.sql`
