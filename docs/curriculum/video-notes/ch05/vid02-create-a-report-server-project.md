...
**Course lesson:** [Create a report server project](https://maharatech.gov.eg/mod/hvp/view.php?id=17611)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17611
- My SQL script: `../scripts/ch05/vid02-create-a-report-server-project.sql`
