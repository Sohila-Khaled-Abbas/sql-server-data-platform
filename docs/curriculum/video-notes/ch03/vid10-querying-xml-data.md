...
**Course lesson:** [Querying XML data](https://maharatech.gov.eg/mod/hvp/view.php?id=17562)  
...
By the end of this lesson, I should be able to explain the core idea behind **Querying XML data**, write/reproduce a small working example, and describe when the feature is useful in a real SQL Server data platform.
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17562
- My SQL script: `../scripts/ch03/vid10-querying-xml-data.sql`
