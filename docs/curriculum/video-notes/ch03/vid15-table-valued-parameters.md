...
- [ ] 🚀 **Production Code Verified** · Documented implementation tracked in `src/03_programmability_and_elt/01_tvps_and_bulk_ingestion.sql`

---

## 1. Learning Objectives & Architectural Focus

By the end of this lesson, I should be able to explain the core idea behind **Table Valued Parameters**, write/reproduce a small working example, and describe when the feature is useful in a real SQL Server data platform.
...
* 🔗 **Official Course Module:** [MaharaTech Lesson 17567](https://maharatech.gov.eg/mod/hvp/view.php?id=17567)
* 💾 **Production Script:** [`src/03_programmability_and_elt/01_tvps_and_bulk_ingestion.sql`](../../../../src/03_programmability_and_elt/01_tvps_and_bulk_ingestion.sql)
