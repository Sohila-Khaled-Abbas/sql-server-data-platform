...
**Course lesson:** [Use Path Mode with For XML](https://maharatech.gov.eg/mod/hvp/view.php?id=17561)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17561
- My SQL script: `../scripts/ch03/vid09-use-path-mode-with-for-xml.sql`
