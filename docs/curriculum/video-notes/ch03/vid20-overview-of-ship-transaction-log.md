...
**Course lesson:** [Overview of Ship Transaction Log](https://maharatech.gov.eg/mod/hvp/view.php?id=17573)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17573
- My SQL script: `../scripts/ch03/vid20-overview-of-ship-transaction-log.sql`
