...
**Course lesson:** [Use Raw and Auto Mode with For XML](https://maharatech.gov.eg/mod/hvp/view.php?id=17560)  
...
By the end of this lesson, I should be able to explain the core idea behind **Use Raw and Auto Mode with For XML**, write/reproduce a small working example, and describe when the feature is useful in a real SQL Server data platform.
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17560
- My SQL script: `../scripts/ch03/vid08-use-raw-and-auto-mode-with-for-xml.sql`
