...
**Course lesson:** [Set Up Instances](https://maharatech.gov.eg/mod/hvp/view.php?id=17569)  
...
By the end of this lesson, I should be able to explain the core idea behind **Set Up Instances**, write/reproduce a small working example, and describe when the feature is useful in a real SQL Server data platform.
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17569
- My SQL script: `../scripts/ch03/vid17-set-up-instances.sql`
