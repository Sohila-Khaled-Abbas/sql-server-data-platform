...
**Course lesson:** [Steps to Configure SQL Server Log Shipping](https://maharatech.gov.eg/mod/hvp/view.php?id=17574)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17574
- My SQL script: `../scripts/ch03/vid21-steps-to-configure-sql-server-log-shipping.sql`
