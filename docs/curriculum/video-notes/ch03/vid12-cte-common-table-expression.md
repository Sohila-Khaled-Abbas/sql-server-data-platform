...
**Course lesson:** [CTE: Common Table Expression](https://maharatech.gov.eg/mod/hvp/view.php?id=17564)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17564
- My SQL script: `../scripts/ch03/vid12-cte-common-table-expression.sql`
