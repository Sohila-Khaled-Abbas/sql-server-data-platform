...
**Course lesson:** [Multi-Statement Table-Valued Functions](https://maharatech.gov.eg/mod/hvp/view.php?id=17545)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17545
- My SQL script: `../scripts/ch02/vid09-multi-statement-table-valued-functions.sql`
