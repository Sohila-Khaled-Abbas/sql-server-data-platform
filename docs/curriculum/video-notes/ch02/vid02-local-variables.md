...
**Course lesson:** [Local Variables](https://maharatech.gov.eg/mod/hvp/view.php?id=17538)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17538
- My SQL script: `../scripts/ch02/vid02-local-variables.sql`
