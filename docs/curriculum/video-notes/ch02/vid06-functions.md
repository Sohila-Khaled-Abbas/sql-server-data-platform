...
**Course lesson:** [Functions](https://maharatech.gov.eg/mod/hvp/view.php?id=17542)  
**Chapter:** SQL Programming Essentials
**Status:** ☐ Watched · ☐ Reproduced · ☐ Understood · ☐ Documented

## 1. What I should learn

By the end of this lesson, I should be able to explain the core idea behind **Functions**, write/reproduce a small working example, and describe when the feature is useful in a real SQL Server data platform.
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17542
- My SQL script: `../scripts/ch02/vid06-functions.sql`
