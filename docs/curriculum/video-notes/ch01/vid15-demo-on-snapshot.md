...
**Course lesson:** [Demo on Snapshot](https://maharatech.gov.eg/mod/hvp/view.php?id=17534)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17534
- My SQL script: `../scripts/ch01/vid15-demo-on-snapshot.sql`
