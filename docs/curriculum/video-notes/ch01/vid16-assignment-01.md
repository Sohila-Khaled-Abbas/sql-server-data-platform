---
title: "CH01_VID16 — Assignment 01"
aliases:
  - "CH01_VID16"
  - "Assignment 01"
...
course_url: "https://maharatech.gov.eg/mod/hvp/view.php?id=17535"
...
> ⬅️ **Previous:** [CH01_VID15 — Demo on Snapshot](vid15-demo-on-snapshot.md) | 📑 **Index:** [102 Video Index](../../VIDEO_INDEX.md) | ➡️ **Next:** [CH02_VID01 — Variables](../ch02/vid01-variables.md)  
> 📌 **Chapter:** [CH01 — Database Creation and Management](../../chapters/ch01-readme.md) · **Official Lesson:** [MaharaTech 17535](https://maharatech.gov.eg/mod/hvp/view.php?id=17535)
...
- [ ] 🚀 **Production Code Verified** · Documented implementation tracked in `src/01_storage_and_schema/05_company_case_study_schema.sql`

---

## 1. Learning Objectives & Architectural Focus

By the end of this lesson, I should be able to explain the core idea behind **Assignment 01**, write/reproduce a small working example, and describe when the feature is useful in a real SQL Server data platform.
...
* 🔗 **Official Course Module:** [MaharaTech Lesson 17535](https://maharatech.gov.eg/mod/hvp/view.php?id=17535)
* 💾 **Production Script:** [`src/01_storage_and_schema/05_company_case_study_schema.sql`](../../../../src/01_storage_and_schema/05_company_case_study_schema.sql)
