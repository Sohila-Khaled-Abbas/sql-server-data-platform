...
**Course lesson:** [Backup & SQL server agent jobs](https://maharatech.gov.eg/mod/hvp/view.php?id=17532)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17532
- My SQL script: `../scripts/ch01/vid13-backup-sql-server-agent-jobs.sql`
