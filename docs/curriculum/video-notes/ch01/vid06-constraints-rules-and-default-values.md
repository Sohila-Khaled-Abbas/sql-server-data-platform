...
**Course lesson:** [Constraints, Rules, and Default Values](https://maharatech.gov.eg/mod/hvp/view.php?id=17525)  
**Chapter:** Database Creation and Management
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17525
- My SQL script: `../scripts/ch01/vid06-constraints-rules-and-default-values.sql`
