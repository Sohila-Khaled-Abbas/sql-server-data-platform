...
**Course lesson:** [Backup Database Using Wizard](https://maharatech.gov.eg/mod/hvp/view.php?id=17531)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17531
- My SQL script: `../scripts/ch01/vid12-backup-database-using-wizard.sql`
