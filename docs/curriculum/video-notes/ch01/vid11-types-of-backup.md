...
**Course lesson:** [Types of Backup](https://maharatech.gov.eg/mod/hvp/view.php?id=17530)  
**Chapter:** Database Creation and Management
**Status:** ☐ Watched · ☐ Reproduced · ☐ Understood · ☐ Documented

## 1. What I should learn

By the end of this lesson, I should be able to explain the core idea behind **Types of Backup**, write/reproduce a small working example, and describe when the feature is useful in a real SQL Server data platform.
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17530
- My SQL script: `../scripts/ch01/vid11-types-of-backup.sql`
