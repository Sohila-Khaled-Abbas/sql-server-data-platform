...
**Course lesson:** [Database Integrity](https://maharatech.gov.eg/mod/hvp/view.php?id=17523)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17523
- My SQL script: `../scripts/ch01/vid04-database-integrity.sql`
