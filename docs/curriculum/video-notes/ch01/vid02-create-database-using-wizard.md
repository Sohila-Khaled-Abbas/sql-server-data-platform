...
**Course lesson:** [Create Database Using Wizard](https://maharatech.gov.eg/mod/hvp/view.php?id=17521)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17521
- My SQL script: `../scripts/ch01/vid02-create-database-using-wizard.sql`
