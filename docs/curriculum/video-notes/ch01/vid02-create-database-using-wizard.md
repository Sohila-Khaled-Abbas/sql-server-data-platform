...
| Aspect | Question |
| :--- | :--- |
| **Correctness** | What invariant or constraint does **Create Database Using Wizard** enforce? |
...
| Resource | Link |
| :--- | :--- |
| Official Lesson | [MaharaTech](https://maharatech.gov.eg/mod/hvp/view.php?id=17521) |
| Production Code | `src/01_storage_and_schema/ch01_vid02_ititest_case_study_schema.sql` |
...
| Source on GitHub | [Repository](https://github.com/Sohila-Khaled-Abbas/sql-server-data-platform/blob/master/src/01_storage_and_schema/ch01_vid02_ititest_case_study_schema.sql) |
