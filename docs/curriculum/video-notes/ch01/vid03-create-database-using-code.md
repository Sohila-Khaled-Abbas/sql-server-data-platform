...
**Course lesson:** [Create Database Using Code](https://maharatech.gov.eg/mod/hvp/view.php?id=17522)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17522
- My SQL script: `../scripts/ch01/vid03-create-database-using-code.sql`
