...
**Course lesson:** [Dynamic Query in Stored Procedure](https://maharatech.gov.eg/mod/hvp/view.php?id=17584)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17584
- My SQL script: `../scripts/ch04/vid07-dynamic-query-in-stored-procedure.sql`
