...
**Course lesson:** [Track User Activity Using Audit Table](https://maharatech.gov.eg/mod/hvp/view.php?id=17589)  
**Chapter:** Procedures, Triggers, and SQL Automation
**Status:** ☐ Watched · ☐ Reproduced · ☐ Understood · ☐ Documented

## 1. What I should learn

By the end of this lesson, I should be able to explain the core idea behind **Track User Activity Using Audit Table**, write/reproduce a small working example, and describe when the feature is useful in a real SQL Server data platform.
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17589
- My SQL script: `../scripts/ch04/vid12-track-user-activity-using-audit-table.sql`
