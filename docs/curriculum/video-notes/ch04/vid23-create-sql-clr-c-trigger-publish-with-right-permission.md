...
**Course lesson:** [Create SQL CLR C# Trigger & publish with right permission](https://maharatech.gov.eg/mod/hvp/view.php?id=17605)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17605
- My SQL script: `../scripts/ch04/vid23-create-sql-clr-c-trigger-publish-with-right-permission.sql`
