...
**Course lesson:** [Creating a Table Level Trigger](https://maharatech.gov.eg/mod/hvp/view.php?id=17586)  
**Chapter:** Procedures, Triggers, and SQL Automation
**Status:** ☐ Watched · ☐ Reproduced · ☐ Understood · ☐ Documented

## 1. What I should learn

By the end of this lesson, I should be able to explain the core idea behind **Creating a Table Level Trigger**, write/reproduce a small working example, and describe when the feature is useful in a real SQL Server data platform.
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17586
- My SQL script: `../scripts/ch04/vid09-creating-a-table-level-trigger.sql`
