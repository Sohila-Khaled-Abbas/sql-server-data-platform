...
**Course lesson:** [Create simple custom application (for end user) using SMO](https://maharatech.gov.eg/mod/hvp/view.php?id=17607)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17607
- My SQL script: `../scripts/ch04/vid25-create-simple-custom-application-for-end-user-using-smo.sql`
