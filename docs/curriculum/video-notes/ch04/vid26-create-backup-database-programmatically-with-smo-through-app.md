...
**Course lesson:** [Create & Backup database programmatically with SMO through app](https://maharatech.gov.eg/mod/hvp/view.php?id=17608)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17608
- My SQL script: `../scripts/ch04/vid26-create-backup-database-programmatically-with-smo-through-app.sql`
