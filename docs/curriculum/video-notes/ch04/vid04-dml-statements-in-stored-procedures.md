...
**Course lesson:** [DML Statements in Stored Procedures](https://maharatech.gov.eg/mod/hvp/view.php?id=17581)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17581
- My SQL script: `../scripts/ch04/vid04-dml-statements-in-stored-procedures.sql`
