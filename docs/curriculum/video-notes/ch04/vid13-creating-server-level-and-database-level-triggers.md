...
**Course lesson:** [Creating Server-Level and Database-Level Triggers](https://maharatech.gov.eg/mod/hvp/view.php?id=17590)  
...
- Lesson URL: https://maharatech.gov.eg/mod/hvp/view.php?id=17590
- My SQL script: `../scripts/ch04/vid13-creating-server-level-and-database-level-triggers.sql`
