...
| Aspect | Question |
| :--- | :--- |
| **Correctness** | What invariant or constraint does **Creating Server-Level and Database-Level Triggers** enforce? |
...
| Resource | Link |
| :--- | :--- |
| Official Lesson | [MaharaTech](https://maharatech.gov.eg/mod/hvp/view.php?id=17590) |
| Production Code | `src/04_governance_and_audit/02_ddl_and_server_triggers.sql` |
...
| Source on GitHub | [Repository](https://github.com/Sohila-Khaled-Abbas/sql-server-data-platform/blob/master/src/04_governance_and_audit/02_ddl_and_server_triggers.sql) |
