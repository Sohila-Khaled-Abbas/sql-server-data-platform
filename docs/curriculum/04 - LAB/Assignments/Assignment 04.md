...
# Assignment 04 — Practical Lab & Assessment

> [!abstract] Objective
> Validate your engineering mastery of **CH04** by building, testing, and debugging practical SQL Server components without referring to solutions.
...
## 📋 Requirements
1. Implement the scenario described in lesson `CH04_VID27`.
...
## 🔗 Connected Lessons
- [[CH04_VID01 - Create Database and Filegroups]] (or Chapter Hub)
