...
# Assignment 03 — Practical Lab & Assessment

> [!abstract] Objective
> Validate your engineering mastery of **CH03** by building, testing, and debugging practical SQL Server components without referring to solutions.
...
## 📋 Requirements
1. Implement the scenario described in lesson `CH03_VID23`.
...
## 🔗 Connected Lessons
- [[CH03_VID01 - Create Database and Filegroups]] (or Chapter Hub)
