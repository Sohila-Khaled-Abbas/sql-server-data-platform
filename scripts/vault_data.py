...
LESSONS_RAW = [
    ...
    ("CH01", "CH01_VID07", "Creating a Custom Data Type", "17526", "src/01_storage_and_schema/ch01_vid07_custom_data_types.sql", "medium", 15),
    ("CH01", "CH01_VID08", "Clustered Index", "17527", "src/01_storage_and_schema/ch01_vid08_clustered_index.sql", "hard", 20),
    ("CH01", "CH01_VID09", "Non-Clustered Index", "17528", "src/01_storage_and_schema/ch01_vid09_nonclustered_index.sql", "hard", 20),
