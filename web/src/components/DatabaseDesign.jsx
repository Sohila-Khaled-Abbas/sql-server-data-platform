        ...
        {activeSchema === 'itiSchema' && (
          <div style={{ marginBottom: '3rem' }}>
            ...
            <div style={{
              ...
              <a
                href="https://github.com/Sohila-Khaled-Abbas/sql-server-data-platform/blob/master/docs/ch01-vid08-clustered-index-live.md"
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  display: 'flex',
              ...
              >
                <FileText size={20} style={{ color: 'var(--accent-emerald)', flexShrink: 0 }} />
                <div>
                  <div style={{ color: '#fff', fontSize: '0.9rem', fontWeight: 600 }}>CH01_VID08 Clustered Index Telemetry</div>
                  <div style={{ color: 'var(--text-muted)', fontSize: '0.75rem', fontFamily: 'var(--font-mono)' }}>
                    docs/ch01-vid08-clustered-index-live.md &nearr;
                  </div>
                </div>
              </a>

              <a
                href="https://github.com/Sohila-Khaled-Abbas/sql-server-data-platform/blob/master/src/01_storage_and_schema/ch01_vid08_clustered_index.sql"
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  display: 'flex',
              ...
              >
                <FileCode size={20} style={{ color: 'var(--accent-cyan)', flexShrink: 0 }} />
                <div>
                  <div style={{ color: '#fff', fontSize: '0.9rem', fontWeight: 600 }}>CH01_VID08 Clustered Index T-SQL</div>
                  <div style={{ color: 'var(--text-muted)', fontSize: '0.75rem', fontFamily: 'var(--font-mono)' }}>
                    src/01_storage_and_schema/ch01_vid08_clustered_index.sql &nearr;
                  </div>
                </div>
              </a>

              <a
                href="https://github.com/Sohila-Khaled-Abbas/sql-server-data-platform/blob/master/docs/ch01-vid09-nonclustered-index-live.md"
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  display: 'flex',
              ...
              >
                <FileText size={20} style={{ color: 'var(--accent-emerald)', flexShrink: 0 }} />
                <div>
                  <div style={{ color: '#fff', fontSize: '0.9rem', fontWeight: 600 }}>CH01_VID09 Non-Clustered Telemetry</div>
                  <div style={{ color: 'var(--text-muted)', fontSize: '0.75rem', fontFamily: 'var(--font-mono)' }}>
                    docs/ch01-vid09-nonclustered-index-live.md &nearr;
                  </div>
                </div>
              </a>

              <a
                href="https://github.com/Sohila-Khaled-Abbas/sql-server-data-platform/blob/master/src/01_storage_and_schema/ch01_vid09_nonclustered_index.sql"
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  display: 'flex',
              ...
              >
                <FileCode size={20} style={{ color: 'var(--accent-cyan)', flexShrink: 0 }} />
                <div>
                  <div style={{ color: '#fff', fontSize: '0.9rem', fontWeight: 600 }}>CH01_VID09 Non-Clustered T-SQL</div>
                  <div style={{ color: 'var(--text-muted)', fontSize: '0.75rem', fontFamily: 'var(--font-mono)' }}>
                    src/01_storage_and_schema/ch01_vid09_nonclustered_index.sql &nearr;
                  </div>
                </div>
              </a>
            </div>
